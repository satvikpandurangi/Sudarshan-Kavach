  ...
  return (
    <div className="card-premium">
            ...
            {cameraActive ? (
              ...
              >
                <div style={{ display: "flex", alignItems: "flex-start", gap: 18, flexWrap: "wrap" }}>
                  ...
                  <div style={{ flex: "1 1 200px", minWidth: 0, width: "100%", maxWidth: "100%" }}>
      ...
      <div className="checker-action-row">
        <p className="text-muted checker-privacy-note" style={{ fontSize: "0.82rem", display: "flex", alignItems: "center", gap: 6, margin: 0, flex: 1, minWidth: 0 }}>
